...
impl ShinEn {
    // ========================================================================
    /// fn new
    pub fn new(path_root: &Path, config: Value) -> Result<Self> {
        info!(
    ...
    // ========================================================================
    /// fn reload_cards
    pub fn reload_cards(&mut self) -> Result<&Self> {
        self.cards.clear();
    ...
    fn on_give(&self, bhv: &mut Behavior) -> Result<Command> {
        ...
        let (player_name, target_player_name, hand) = {
            ...
            let (player_name, _player_uuid, card_name, hand) =
                match self.hand_pickup(
                    bhv,
                    &label,
                    &matches.free[0],
