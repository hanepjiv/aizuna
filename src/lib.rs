...
#![deny(
    ...
    intra_doc_link_resolution_failure, late_bound_lifetime_arguments,
    ...
    safe_packed_borrows, stable_features, trivial_bounds, type_alias_bounds,
    ...
    const_err, duplicate_macro_exports, exceeding_bitshifts,
